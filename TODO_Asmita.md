...
- [ ] `[HUMAN]` **0.A.5** Register a domain for Asmita, for example `asmita.in`. Set up `notices@asmita.in` email with DKIM, SPF, and DMARC records. Document the DNS setup in `docs/infra/email-dns.md`.
